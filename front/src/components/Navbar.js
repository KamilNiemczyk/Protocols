    ...
    return (
        <div className="bg-gray-700 mb-30">
            <div className="flex justify-between">
                ...
                <div className='ml-auto text-white mt-auto mb-auto'> <Link to="/" className="hover:bg-green-400 text-white hover:text-black px-20 py-2 border border-white hover:border-black rounded transition duration-300">Ogłoszenia</Link></div>
